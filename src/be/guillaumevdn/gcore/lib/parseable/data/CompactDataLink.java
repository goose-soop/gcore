package be.guillaumevdn.gcore.lib.parseable.data;
...
public class CompactDataLink extends RegularDataLink {
	...
	public CompactDataLink(Parseable component, GPlugin plugin, String superId, YMLConfiguration config, String path) {
