...
public class PCLocale {

	// ----------------------------------------------------------------------
	// Fields
	// ----------------------------------------------------------------------

	public static final File file = new File(PyrCore.inst().getDataFolder() + "/texts.yml");
	public static final File fileUnknown = new File(PyrCore.inst().getDataFolder() + "/texts_unknown.yml");
	...
	// pyrcore messages
	public static final Text MSG_PYRCORE_INVALIDPLUGINPARAM = new Text(
			"MSG_PYRCORE_INVALIDPLUGINPARAM", file,
			"en_US", "&6{plugin} >> &7Parameter &c{parameter} &7should be a plugin registered with PyrCore.",
			"fr_FR", "&6{plugin} >> &7Le paramètre &c{parameter} &7devrait être un plugin enregistré avec Pyrcore.",
			"hu_HU", "&6{plugin} >> &7A paraméter &c{parameter} &7a PyrCore-ban regisztrált bővítménynek kell lennie.",
			"it_IT", Utils.asList("&6{plugin} >> &7Il parametro &c{parameter} &7a dovrebbe essere un plugin registrato con PyrCore.")
			);

	public static final Text MSG_PYRCORE_PLUGINSLIST = new Text(
			"MSG_PYRCORE_PLUGINSLIST", file,
