...
public class CommandCall {
	...
	public CommandCall(PyrPlugin plugin, CommandSender sender, String commandName, List<String> arguments, Map<String, String> parameters) {
		this.plugin = plugin;
		this.sender = sender;
	...
	public boolean ensureSenderIsPlayer() {
		// isn't player
		if (!senderIsPlayer()) {
			PCLocale.MSG_GENERIC_NOTPLAYER.send(sender, "{plugin}", plugin.getName());
			return false;
		}
		// is player
		return true;
