...
public class CommandRoot extends CommandArgument implements CommandExecutor, TabCompleter {
	...
	// base
	public CommandRoot(PyrPlugin plugin, List<String> aliases, String description, Perm permission, boolean playerOnly) {
		super(plugin, aliases, description, permission, playerOnly);
	}

	public CommandRoot(PyrPlugin plugin, List<String> aliases, String description, Perm permission, boolean playerOnly, Param... expectedParams) {
