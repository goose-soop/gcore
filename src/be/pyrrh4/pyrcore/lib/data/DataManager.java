...
import be.pyrrh4.pyrcore.lib.data.mysql.MySQL;
...
public abstract class DataManager {
	...
	public DataManager(PyrPlugin plugin, BackEnd backEnd) {
		this(plugin, backEnd, plugin.getConfiguration().getInt("data.sync_delay", -1));
	}

	public DataManager(PyrPlugin plugin, BackEnd backEnd, int syncDelay) {
		this.plugin = plugin;
