...
public class SettingFloat extends AbstractUniqueSetting<Float> {

	// base
	public SettingFloat(String id, String def, boolean mandatory, List<String> description) {
			...
			protected void onClick(Player player, ClickType clickType, int pageIndex) {
				...
				PyrCore.inst().getChatInputs().put(player, new ChatInput() {
					...
					public void onChat(Player player, String value) {
						// TODO : verify that value contains either a valid float, either a PAPI variable, either a QC variable
