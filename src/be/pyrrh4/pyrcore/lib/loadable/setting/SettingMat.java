...
public class SettingMat extends AbstractUniqueSetting<Mat> {

	// base
	public SettingMat(String id, String def, boolean mandatory, List<String> description) {
		super(id, def, mandatory, "material", description);
	}

	// get
	@Override
	public Mat parse(String raw) {
		return Mat.from(raw, 0);
	}
