...
public class SettingPerm extends AbstractUniqueSetting<Perm> {

	// base
	public SettingPerm(String id, String def, boolean mandatory, List<String> description) {
		super(id, def, mandatory, "permission", description);
	}

	// get
	@Override
	public Perm parse(String raw) {
		return new Perm(null, raw, false);
	}
