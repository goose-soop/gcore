...
public class SettingStringList extends AbstractListSetting<List<String>> {
	...
	// base
	public SettingStringList(String id, List<String> def, boolean mandatory, List<String> description) {
		super(id, def, mandatory, "list of text", description);
	}
	...
	public List<String> getParsed(Player player) {
		List<String> result = super.getParsed(player);
		return result != null ? result : Utils.emptyList();
	}
