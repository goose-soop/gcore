...
public class MessageTarget
{
	...
	public void send(String message) {
		...
		// Unknown
			...
			Logger.log(Level.WARNING, "PyrCore", "Could not send message (unknown target type : " + target.getClass() + ")");
			Logger.log(Level.WARNING, "PyrCore", ">> " + message);
		}
	}
	...
	public void send(List<String> message) {
		...
		// Unknown
			...
			Logger.log(Level.WARNING, "PyrCore", "Could not send message (unknown target type : " + target.getClass() + ")");
			for (String str : message) Logger.log(Level.WARNING, "PyrCore", ">> " + str);
		}
	}
}
