...
public class PPBoolean extends PrimitiveParseable<Boolean> {
	...
	protected void fillEditor(final EditorGUI gui, Player player, final ModifCallback onModif) {
		...
		// toggle
		gui.setRegularItem(new EditorItem("control_item_toggle", 2, Mat.BAKED_POTATO, PCLocale.GUI_GENERIC_EDITORBOOLEANTOGGLE.getLine(), PCLocale.GUI_GENERIC_EDITORBOOLEANTOGGLELORE.getLines()) {
			@Override
