...
public class PPWorld extends PrimitiveParseable<World> {
	...
	public void fillEditor(final EditorGUI gui, Player player, final ModifCallback onModif) {
		...
		// select
		gui.setRegularItem(new EditorItem("select", 2, Mat.ENDER_CHEST, PCLocale.GUI_GENERIC_EDITORENUMSELECT.getLine(), PCLocale.GUI_GENERIC_EDITORENUMSELECTLORE.getLines()) {
			@Override
