...
package be.pyrrh4.pyrcore.lib.versioncompat.npc;
...
public class NpcProtocols1_9_4 extends NpcProtocols {
	...
	public WrappedDataWatcher spawn(final Player player, int entityId, String name, Location location, UUID skin) {
		...
		// skin
		SkinData skinData = skin != null && PyrCore.inst().getData().getNpcSkins() != null ? PyrCore.inst().getData().getNpcSkins().get(skin) : null;
		if (skinData != null) {
		...
		}.runTaskLater(PyrCore.inst(), skin == null ? 5L : 40L);
		// update look
