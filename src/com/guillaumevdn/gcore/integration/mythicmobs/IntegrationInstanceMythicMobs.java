package com.guillaumevdn.gcore.integration.mythicmobs;

import java.util.Map;

import com.guillaumevdn.gcore.integration.mythicmobs.position.PositionTypeClosestMythicMobRelativeAreaInside;
import com.guillaumevdn.gcore.integration.mythicmobs.position.PositionTypeClosestMythicMobRelativeAreaOutside;
import com.guillaumevdn.gcore.integration.mythicmobs.position.PositionTypeClosestMythicMobRelativeCylinderInside;
import com.guillaumevdn.gcore.integration.mythicmobs.position.PositionTypeClosestMythicMobRelativeCylinderOutside;
import com.guillaumevdn.gcore.integration.mythicmobs.position.PositionTypeClosestMythicMobRelativeSingle;
import com.guillaumevdn.gcore.integration.mythicmobs.position.PositionTypeClosestMythicMobRelativeSphereInside;
import com.guillaumevdn.gcore.integration.mythicmobs.position.PositionTypeClosestMythicMobRelativeSphereOutside;
 ...
 * @author GuillaumeVDN
 */
public class IntegrationInstanceMythicMobs extends IntegrationInstance {

	public IntegrationInstanceMythicMobs(Integration integration) {
		super(integration);
