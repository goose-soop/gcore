 ...
 * @author GuillaumeVDN
 */
public class ArgumentPairFixedStringDouble extends Argument<Double> {

	private List<String> fixedStrings;

	public ArgumentPairFixedStringDouble(NeedType need, boolean playerOnly, Permission permission, Text usage, List<String> fixedStrings) {
