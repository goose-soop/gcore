...
public class SectionNode extends ConfigNode {
	...
	public SectionNode(SectionNode parent, String id, String trailingComment) {
		super(parent, id);
	...
	public void purgeEmptySections() {
		CollectionUtils.iterate(nodes, (iterator, next, breaker) -> {
	...
	public SectionNode addSection(String id) {
		SectionNode node = new SectionNode(this, id, null);
		addNode(node);
		return node;
	}
	...
	// convert
	public DataIO toIO(boolean snakeCaseToCamelCase) {
	...
	public SectionNode clone(SectionNode parent) {
		SectionNode clone = new SectionNode(parent, getId(), trailingComment);
