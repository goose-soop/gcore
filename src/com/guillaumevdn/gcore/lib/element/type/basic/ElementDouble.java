 ...
 * @author GuillaumeVDN
 */
public class ElementDouble extends ElementValue<Double> {

	private final double min, max;

	public ElementDouble(Element parent, String id, Need need, Text editorDescription) {
		this(parent, id, need, -Double.MAX_VALUE, editorDescription);
	}

	public ElementDouble(Element parent, String id, Need need, double min, Text editorDescription) {
