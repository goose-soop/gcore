...
public class EventBehaviorCall extends BEvent {

	// base
	public EventBehaviorCall(String id, Parseable parent, boolean mandatory, int editorSlot, Mat editorIcon, List<String> editorDescription) {
		super(id, BEventType.BEHAVIOR_CALL, parent, mandatory, editorSlot, editorIcon, editorDescription);
	}

	// methods
	@Override
	public boolean triggerAttempt(AttemptContext context, Player player, Npc npc, Event event) {
		return context.equals(AttemptContext.CALL);
	}
