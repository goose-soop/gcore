...
public class Compat1_12 extends Compat {
	...
	public void sendTitle(Player player, String title, String subtitle, int fadeIn, int duration, int fadeOut) {
		if (subtitle != null || title != null) {
			...
			net.minecraft.server.v1_12_R1.PacketPlayOutTitle packetPlayOutTimes = new net.minecraft.server.v1_12_R1.PacketPlayOutTitle(
					net.minecraft.server.v1_12_R1.PacketPlayOutTitle.EnumTitleAction.TIMES, null, fadeIn, duration, fadeOut);
			...
			if (subtitle != null) {
				...
				net.minecraft.server.v1_12_R1.PacketPlayOutTitle packetPlayOutSubTitle = new net.minecraft.server.v1_12_R1.PacketPlayOutTitle(
						net.minecraft.server.v1_12_R1.PacketPlayOutTitle.EnumTitleAction.SUBTITLE, titleSub);
			...
			if (title != null) {
				...
				net.minecraft.server.v1_12_R1.PacketPlayOutTitle packetPlayOutTitle = new net.minecraft.server.v1_12_R1.PacketPlayOutTitle(
						net.minecraft.server.v1_12_R1.PacketPlayOutTitle.EnumTitleAction.TITLE, titleMain);
	...
	public void sendActionBar(Player player, String message) {
		net.minecraft.server.v1_12_R1.IChatBaseComponent actionbar = net.minecraft.server.v1_12_R1.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + message + "\"}");
		net.minecraft.server.v1_12_R1.PacketPlayOutChat actionbarPacket = new net.minecraft.server.v1_12_R1.PacketPlayOutChat(actionbar, net.minecraft.server.v1_12_R1.ChatMessageType.GAME_INFO);
		((org.bukkit.craftbukkit.v1_12_R1.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(actionbarPacket);
	}

	@Override
	public void changeTab(Player player, String head, String foot) {
		net.minecraft.server.v1_12_R1.IChatBaseComponent header = net.minecraft.server.v1_12_R1.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + head + "\"}");
		net.minecraft.server.v1_12_R1.IChatBaseComponent footer = net.minecraft.server.v1_12_R1.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + foot + "\"}");
	...
	public Object parseMojangson(String serialized) throws Throwable {
		return net.minecraft.server.v1_12_R1.MojangsonParser.parse(serialized);
	}

	@Override
	public String serializeNbt(Object nbt) throws IOException {
		if (Utils.instanceOf(nbt, net.minecraft.server.v1_12_R1.NBTTagCompound.class)) {
			// convert to byte array
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			net.minecraft.server.v1_12_R1.NBTCompressedStreamTools.a((net.minecraft.server.v1_12_R1.NBTTagCompound) nbt, baos);
	...
	public Object unserializeNbt(String serialized) throws IOException {
		if (serialized != null) {
			...
			return net.minecraft.server.v1_12_R1.NBTCompressedStreamTools.a(bais);
		}
		return null;
	}
	...
	public Object getNbt(ItemStack item) {
		if (item != null) {
			net.minecraft.server.v1_12_R1.ItemStack itemNms = org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.asNMSCopy(item);
	...
	public ItemStack setNbt(ItemStack item, Object nbt) {
		if (item != null) {
			net.minecraft.server.v1_12_R1.ItemStack itemNms = org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.asNMSCopy(item);
			itemNms.setTag((net.minecraft.server.v1_12_R1.NBTTagCompound) (nbt == null ? null : nbt));
			// return item
			return org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.asBukkitCopy(itemNms);
		}
		return null;
	}
	...
	public double getAttackDamage(ItemStack item) {
		...
		net.minecraft.server.v1_12_R1.Item nmsItem = nmsStack.getItem();
		if (nmsItem instanceof net.minecraft.server.v1_12_R1.ItemSword || nmsItem instanceof net.minecraft.server.v1_12_R1.ItemTool || nmsItem instanceof net.minecraft.server.v1_12_R1.ItemHoe) {
			Multimap<String,  net.minecraft.server.v1_12_R1.AttributeModifier> map = nmsItem.a(net.minecraft.server.v1_12_R1.EnumItemSlot.MAINHAND);
			Collection<net.minecraft.server.v1_12_R1.AttributeModifier> attributes = map.get(net.minecraft.server.v1_12_R1.GenericAttributes.ATTACK_DAMAGE.getName());
			if(!attributes.isEmpty()) {
				for (net.minecraft.server.v1_12_R1.AttributeModifier am : attributes) {
