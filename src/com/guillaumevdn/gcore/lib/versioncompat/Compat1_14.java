...
public class Compat1_14 extends Compat {
	...
	public ItemStack setNbt(ItemStack item, Object nbt) {
		if (item != null) {
			net.minecraft.server.v1_14_R1.ItemStack itemNms = org.bukkit.craftbukkit.v1_14_R1.inventory.CraftItemStack.asNMSCopy(item);
			itemNms.setTag((net.minecraft.server.v1_14_R1.NBTTagCompound) (nbt));
			// return item
	...
	public double getAttackDamage(ItemStack item) {
		...
		net.minecraft.server.v1_14_R1.ItemStack nmsStack = org.bukkit.craftbukkit.v1_14_R1.inventory.CraftItemStack.asNMSCopy(item);
		net.minecraft.server.v1_14_R1.Item nmsItem = nmsStack.getItem();
		if (nmsItem instanceof net.minecraft.server.v1_14_R1.ItemSword || nmsItem instanceof net.minecraft.server.v1_14_R1.ItemTool || nmsItem instanceof net.minecraft.server.v1_14_R1.ItemHoe) {
			Multimap<String, net.minecraft.server.v1_14_R1.AttributeModifier> map = nmsItem.a(net.minecraft.server.v1_14_R1.EnumItemSlot.MAINHAND);
			Collection<net.minecraft.server.v1_14_R1.AttributeModifier> attributes = map.get(net.minecraft.server.v1_14_R1.GenericAttributes.ATTACK_DAMAGE.getName());
			if(!attributes.isEmpty()) {
				for (net.minecraft.server.v1_14_R1.AttributeModifier am : attributes) {
					if (am.a().toString().equalsIgnoreCase(uuid.toString()) && am.c().equals(net.minecraft.server.v1_14_R1.AttributeModifier.Operation.ADDITION)) {
						attackDamage += am.d();
					}
				}
				double y = 1;
				for (net.minecraft.server.v1_14_R1.AttributeModifier am : attributes) {
					if(am.a().toString().equalsIgnoreCase(uuid.toString()) && am.c().equals(net.minecraft.server.v1_14_R1.AttributeModifier.Operation.MULTIPLY_BASE)) {
						y += am.d();
					}
				}
				attackDamage *= y;
				for(net.minecraft.server.v1_14_R1.AttributeModifier am : attributes) {
					if(am.a().toString().equalsIgnoreCase(uuid.toString()) && am.c().equals(net.minecraft.server.v1_14_R1.AttributeModifier.Operation.MULTIPLY_TOTAL)) {
						attackDamage *= (1 + am.d());
					}
				}
			}
