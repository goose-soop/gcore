...
public class Compat1_7_10 extends Compat {
	...
	public Object parseMojangson(String serialized) throws Throwable {
		return net.minecraft.server.v1_7_R4.MojangsonParser.parse(serialized);
	}

	@Override
	public String serializeNbt(Object nbt) throws IOException {
		if (Utils.instanceOf(nbt, net.minecraft.server.v1_7_R4.NBTTagCompound.class)) {
			// convert to byte array
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			net.minecraft.server.v1_7_R4.NBTCompressedStreamTools.a((net.minecraft.server.v1_7_R4.NBTTagCompound) nbt, baos);
	...
	public Object unserializeNbt(String serialized) throws IOException {
		if (serialized != null) {
			...
			return net.minecraft.server.v1_7_R4.NBTCompressedStreamTools.a(bais);
		}
		return null;
	}
	...
	public Object getNbt(ItemStack item) {
		if (item != null) {
			net.minecraft.server.v1_7_R4.ItemStack itemNms = org.bukkit.craftbukkit.v1_7_R4.inventory.CraftItemStack.asNMSCopy(item);
	...
	public ItemStack setNbt(ItemStack item, Object nbt) {
		if (item != null) {
			net.minecraft.server.v1_7_R4.ItemStack itemNms = org.bukkit.craftbukkit.v1_7_R4.inventory.CraftItemStack.asNMSCopy(item);
			itemNms.setTag((net.minecraft.server.v1_7_R4.NBTTagCompound) (nbt == null ? null : nbt));
			// return item
			return org.bukkit.craftbukkit.v1_7_R4.inventory.CraftItemStack.asBukkitCopy(itemNms);
		}
		return null;
	}
	...
	public double getAttackDamage(ItemStack item) {
		...
		net.minecraft.server.v1_7_R4.ItemStack nmsStack = org.bukkit.craftbukkit.v1_7_R4.inventory.CraftItemStack.asNMSCopy(item);
		net.minecraft.server.v1_7_R4.Item nmsItem = nmsStack.getItem();
		if (nmsItem instanceof net.minecraft.server.v1_7_R4.ItemSword || nmsItem instanceof net.minecraft.server.v1_7_R4.ItemTool || nmsItem instanceof net.minecraft.server.v1_7_R4.ItemHoe) {
			Multimap<String, net.minecraft.server.v1_7_R4.AttributeModifier> map = (Multimap<String, net.minecraft.server.v1_7_R4.AttributeModifier>) nmsItem.k();
			Collection<net.minecraft.server.v1_7_R4.AttributeModifier> attributes = map.get(net.minecraft.server.v1_7_R4.GenericAttributes.e.getName());
			if(!attributes.isEmpty()) {
				for (net.minecraft.server.v1_7_R4.AttributeModifier am : attributes) {
