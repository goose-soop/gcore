...
public class Compat1_8 extends Compat {
	...
	public void sendTitle(Player player, String title, String subtitle, int fadeIn, int duration, int fadeOut) {
		if (subtitle != null || title != null) {
			...
			net.minecraft.server.v1_8_R3.PacketPlayOutTitle packetPlayOutTimes = new net.minecraft.server.v1_8_R3.PacketPlayOutTitle(
					net.minecraft.server.v1_8_R3.PacketPlayOutTitle.EnumTitleAction.TIMES, null, fadeIn, duration, fadeOut);
			...
			if (subtitle != null) {
				...
				net.minecraft.server.v1_8_R3.PacketPlayOutTitle packetPlayOutSubTitle = new net.minecraft.server.v1_8_R3.PacketPlayOutTitle(
						net.minecraft.server.v1_8_R3.PacketPlayOutTitle.EnumTitleAction.SUBTITLE, titleSub);
				connection.sendPacket(packetPlayOutSubTitle);
			}

			if (title != null) {
				net.minecraft.server.v1_8_R3.IChatBaseComponent titleMain = net.minecraft.server.v1_8_R3.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + title + "\"}");
				net.minecraft.server.v1_8_R3.PacketPlayOutTitle packetPlayOutTitle = new net.minecraft.server.v1_8_R3.PacketPlayOutTitle(
						net.minecraft.server.v1_8_R3.PacketPlayOutTitle.EnumTitleAction.TITLE, titleMain);
	...
	public void sendActionBar(Player player, String message) {
		net.minecraft.server.v1_8_R3.IChatBaseComponent actionbar = net.minecraft.server.v1_8_R3.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + message + "\"}");
		net.minecraft.server.v1_8_R3.PacketPlayOutChat actionbarPacket = new net.minecraft.server.v1_8_R3.PacketPlayOutChat(actionbar, (byte)2);
		((org.bukkit.craftbukkit.v1_8_R3.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(actionbarPacket);
	}

	@Override
	public void changeTab(Player player, String head, String foot) {
		net.minecraft.server.v1_8_R3.IChatBaseComponent header = net.minecraft.server.v1_8_R3.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + head + "\"}");
		net.minecraft.server.v1_8_R3.IChatBaseComponent footer = net.minecraft.server.v1_8_R3.IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + foot + "\"}");
	...
	public Object parseMojangson(String serialized) throws Throwable {
		return net.minecraft.server.v1_8_R3.MojangsonParser.parse(serialized);
	}

	@Override
	public String serializeNbt(Object nbt) throws IOException {
		if (Utils.instanceOf(nbt, net.minecraft.server.v1_8_R3.NBTTagCompound.class)) {
			// convert to byte array
			ByteArrayOutputStream baos = new ByteArrayOutputStream();
			net.minecraft.server.v1_8_R3.NBTCompressedStreamTools.a((net.minecraft.server.v1_8_R3.NBTTagCompound) nbt, baos);
	...
	public Object unserializeNbt(String serialized) throws IOException {
		if (serialized != null) {
			...
			return net.minecraft.server.v1_8_R3.NBTCompressedStreamTools.a(bais);
		}
		return null;
	}
	...
	public ItemStack setNbt(ItemStack item, Object nbt) {
		if (item != null) {
			net.minecraft.server.v1_8_R3.ItemStack itemNms = org.bukkit.craftbukkit.v1_8_R3.inventory.CraftItemStack.asNMSCopy(item);
			itemNms.setTag((net.minecraft.server.v1_8_R3.NBTTagCompound) (nbt == null ? null : nbt));
			// return item
