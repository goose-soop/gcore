...
public class Compat1_9_4 extends Compat {
	...
	public Object parseMojangson(String serialized) throws Throwable {
		return net.minecraft.server.v1_9_R2.MojangsonParser.parse(serialized);
	}
	...
	public ItemStack setNbt(ItemStack item, Object nbt) {
		if (item != null) {
			net.minecraft.server.v1_9_R2.ItemStack itemNms = org.bukkit.craftbukkit.v1_9_R2.inventory.CraftItemStack.asNMSCopy(item);
			itemNms.setTag((net.minecraft.server.v1_9_R2.NBTTagCompound) (nbt));
			// return item
	...
	public double getAttackDamage(ItemStack item) {
		...
		net.minecraft.server.v1_9_R2.ItemStack nmsStack = org.bukkit.craftbukkit.v1_9_R2.inventory.CraftItemStack.asNMSCopy(item);
		net.minecraft.server.v1_9_R2.Item nmsItem = nmsStack.getItem();
		if (nmsItem instanceof net.minecraft.server.v1_9_R2.ItemSword || nmsItem instanceof net.minecraft.server.v1_9_R2.ItemTool || nmsItem instanceof net.minecraft.server.v1_9_R2.ItemHoe) {
			Multimap<String,  net.minecraft.server.v1_9_R2.AttributeModifier> map = nmsItem.a(net.minecraft.server.v1_9_R2.EnumItemSlot.MAINHAND);
			Collection<net.minecraft.server.v1_9_R2.AttributeModifier> attributes = map.get(net.minecraft.server.v1_9_R2.GenericAttributes.ATTACK_DAMAGE.getName());
			if(!attributes.isEmpty()) {
				for (net.minecraft.server.v1_9_R2.AttributeModifier am : attributes) {
