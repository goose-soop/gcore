...
public enum Sound {
	...
	AMBIENCE_THUNDER("AMBIENCE_THUNDER", "ENTITY_LIGHTNING_THUNDER", "ENTITY_LIGHTNING_BOLT_THUNDER", null),
	...
	BLOCK_CONDUIT_ACTIVATE(null, "BLOCK_CONDUIT_ACTIVATE"),
	BLOCK_CONDUIT_DEACTIVATE(null, "BLOCK_CONDUIT_DEACTIVATE"),
	CHEST_CLOSE("CHEST_CLOSE", "BLOCK_CHEST_CLOSE"),
	CHEST_OPEN("CHEST_OPEN", "BLOCK_CHEST_OPEN"),
	CLICK("CLICK", "BLOCK_LEVER_CLICK"),
	...
	FIRE_IGNITE("FIRE_IGNITE", "ITEM_FIRECHARGE_USE"),
	FIZZ("FIZZ", "ENTITY_TNT_PRIMED"),
	FUSE("FUSE", "ENTITY_TNT_PRIMED"),
	GLASS("GLASS", "BLOCK_GLASS_HIT"),
	HURT_FLESH("HURT_FLESH", "ENTITY_GENERIC_HURT"),
	...
	SPLASH2("SPLASH2", "ENTITY_SPLASH_POTION_THROW"),
	...
	WOOD_CLICK("WOOD_CLICK", "BLOCK_WOODEN_BUTTON_CLICK_ON"),
	...
	GHAST_FIREBALL("GHAST_FIREBALL", "ENTITY_ENDERDRAGON_FIREBALL_EXPLODE"),
	...
	WITCH_AMBIENT(null, "ENTITY_WITCH_AMBIENT"),
	WITCH_DEATH(null, "ENTITY_WITCH_DEATH"),
	WITCH_DRINK(null, "ENTITY_WITCH_DRINK"),
	WITCH_HURT(null, "ENTITY_WITCH_HURT"), 
	WITCH_THROW(null, "ENTITY_WITCH_THROW"),
	...
	ZOMBIE_DEATH("ZOMBIE_DEATH", "ENTITY_ZOMBIE_PIG_DEATH"),
	...
	DIG_WOOL("DIG_WOOL", "BLOCK_SNOW_BREAK"),
	...
	SUCCESSFUL_HIT("SUCCESSFUL_HIT", "ENTITY_PLAYER_HURT"),
	...
	HORSE_ZOMBIE_HIT("HORSE_ZOMBIE_HIT", "ENTITY_ZOMBIE_HURT"),
	HORSE_ZOMBIE_IDLE("HORSE_ZOMBIE_IDLE", "ENTITY_ZOMBIE_HORSE_AMBIENT"),
	VILLAGER_DEATH("VILLAGER_DEATH", "ENTITY_VILLAGER_DEATH"),
	VILLAGER_HAGGLE("VILLAGER_HAGGLE", "ENTITY_VILLAGER_TRADING", "ENTITY_VILLAGER_TRADE", null),
	...
	BLOCK_BEACON_ACTIVATE(null, null, "BLOCK_BEACON_ACTIVATE"),
	BLOCK_BEACON_AMBIENT(null, null, "BLOCK_BEACON_AMBIENT"),
	BLOCK_BEACON_DEACTIVATE(null, null, "BLOCK_BEACON_DEACTIVATE"),
	BLOCK_BEACON_POWER_SELECT(null, null, "BLOCK_BEACON_POWER_SELECT")
	;
	...
	private final String name_1_8, name_1_9, name_1_13, name_1_14;
	...
	private Sound(String n18, String n19, String n113) {
		this(n18, n19, n113, null);
	}

	private Sound(String n18, String n19, String n113, String n114) {
		this.name_1_8 = n18;
		this.name_1_9 = n19;
		this.name_1_13 = n113;
		this.name_1_14 = n114;
	...
	private String getLatestName(boolean n19, boolean n113, boolean n114) {
		if (name_1_14 != null && n114) {
			return name_1_14;
		} else if (name_1_13 != null && n113) {
			return name_1_13;
		} else if (name_1_9 != null && n19) {
			return name_1_9;
		}
		return name_1_8;
	}
	...
	public String getName() {
		return getLatestName(ServerVersion.IS_1_9, ServerVersion.IS_1_13, ServerVersion.IS_1_14);
	}
	...
	public void play(Location location, float volume, float pitch) {
		org.bukkit.Sound sound = Utils.valueOfOrNull(org.bukkit.Sound.class, getName());
		if (sound != null) {
	...
	public void play(Collection<? extends Player> players, float volume, float pitch) {
		...
		if (sound != null) {
			for (Player pl : players) {
				pl.playSound(pl.getEyeLocation(), sound, volume, pitch);
			}
		}
	}
