...
public final class ListenerChatChannelEvent implements Listener {
    ...
    /*
     * @EventHandler public void event(ChatChannelEvent og) { Player player = ObjectUtils.castOrNull(og.getSender(),
     * Player.class); if (player != null) { PlayerChatEvent event = PlayerChatEvent.call(player, og.getMessage(),
