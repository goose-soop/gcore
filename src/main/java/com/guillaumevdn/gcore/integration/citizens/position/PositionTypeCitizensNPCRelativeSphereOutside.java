 ...
 * @author GuillaumeVDN
 */
public class PositionTypeCitizensNPCRelativeSphereOutside extends PositionTypeCitizensNPCRelative {

	public PositionTypeCitizensNPCRelativeSphereOutside(String id) {
		super(id);
	}
