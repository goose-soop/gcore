...
import com.guillaumevdn.gcore.integration.mythicmobs.v5.element.ElementMythicMobsMobList;
...
public abstract class PositionTypeClosestMythicMob extends PositionType {
	...
	public static Location findMatching(ElementPosition position, Replacer replacer) {
		...
		Stream<ActiveMob> stream = MythicProvider.get().getMobManager().getActiveMobs().stream();
		// filter by type
