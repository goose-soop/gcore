...
import com.guillaumevdn.gcore.lib.location.position.type.cylinder.PositionCylinderOutside;
import com.guillaumevdn.gcore.lib.string.placeholder.Replacer;

/**
 * @author GuillaumeVDN
 */
public class PositionTypeClosestMythicMobRelativeCylinderOutside extends PositionTypeClosestMythicMob {

	public PositionTypeClosestMythicMobRelativeCylinderOutside(String id) {
		super(id);
	}
