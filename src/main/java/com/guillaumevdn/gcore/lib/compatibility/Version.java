...
public enum Version {
    ...
    MC_1_21_R1(CollectionUtils.asList("1.21", "1.21.1"), "v1_21_R1", true),
    MC_1_21_R3(CollectionUtils.asList("1.21.2", "1.21.3"), "v1_21_R2", true),
    ...
    public static final boolean ATLEAST_1_20_5 = CURRENT.isMoreOrEqualsTo(MC_1_20_R4);
    public static final boolean ATLEAST_1_21 = CURRENT.isMoreOrEqualsTo(MC_1_21_R1);
    public static final boolean ATLEAST_1_21_3 = CURRENT.isMoreOrEqualsTo(MC_1_21_R3);
    public static final boolean REMAPPED = CURRENT.useRemappedNMSPackages();
    public static final boolean MOJANG_MAPPINGS = ATLEAST_1_20_5 && classExists("com.destroystokyo.paper.PaperConfig");
