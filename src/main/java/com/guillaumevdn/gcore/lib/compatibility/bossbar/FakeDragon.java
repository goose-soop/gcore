...
public final class FakeDragon
{
    ...
    private Object getWatcher() throws Throwable {
        ...
        method.invoke(watcher.justGet(), 6, Float.valueOf((float) getBossbar().getProgress()));
        method.invoke(watcher.justGet(), 7, Integer.valueOf(0));
        method.invoke(watcher.justGet(), 8, Byte.valueOf((byte) 1));
        method.invoke(watcher.justGet(), 10, getBossbar().getTitle());
        method.invoke(watcher.justGet(), 11, Byte.valueOf((byte) 1));
