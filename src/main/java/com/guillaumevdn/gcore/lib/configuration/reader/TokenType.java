...
public enum TokenType {
	...
	LINE_BREAK(new ReaderLineBreak()), COMMENT(new ReaderComment()),

	LIST_COMPACT(new ReaderListCompact()), LIST_EZ(new ReaderListEz()), LIST(new ReaderList()),

	VALUE_DEVELOPED(new ReaderValueDeveloped()), VALUE_DEVELOPED_WEAK(new ReaderValueDevelopedWeak()), VALUE(new ReaderValue()),

	SECTION(new ReaderSection()), SECTION_NESTED_MAP(new ReaderCompactNestedMap()), SECTION_EMPTY(new ReaderSectionEmpty()),
	...
	public static final List<TokenType> IDENTIFIABLE = CollectionUtils.asList(SECTION_EMPTY, SECTION_COMPACT, SECTION_NESTED_MAP,

			LIST_COMPACT, LIST_EZ, LIST,

			VALUE_DEVELOPED, VALUE_DEVELOPED_WEAK, VALUE,
