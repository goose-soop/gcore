...
public enum ProjectileType {
	...
	ARROW("ARROW"), SPECTRAL_ARROW("SPECTRAL_ARROW"), EGG("EGG"), SNOWBALL("SNOWBALL"), FIREBALL("FIREBALL"), EXP_BOTTLE("THROWN_EXP_BOTTLE"),
	ENDER_PEARL("ENDER_PEARL"), TRIDENT("TRIDENT");
