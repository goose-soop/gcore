 ...
 * @author GuillaumeVDN
 */
public class PositionTypePlayerRelativeCylinderInside extends PositionType {

	public PositionTypePlayerRelativeCylinderInside(String id) {
	...
	public Position doParse(ElementPosition position, Replacer replacer) throws ParsingError {
		...
		return new PositionCylinderInside(center, radius, false);
	}
