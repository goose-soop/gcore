 ...
 * @author GuillaumeVDN
 */
public class PositionTypePlayerRelativeSphereOutside extends PositionType {

	public PositionTypePlayerRelativeSphereOutside(String id) {
	...
	public Position doParse(ElementPosition position, Replacer replacer) throws ParsingError {
		...
		return new PositionSphereOutside(center, radius, false);
	}
