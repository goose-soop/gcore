...
/**
 * Given a type T, looks for the annotation {@link JsonAdapter} and uses an instance of the specified class as the
...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
  ...
  TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> type, JsonAdapter annotation) {
    ...
    if (instance instanceof TypeAdapter) {
      ...
      throw new IllegalArgumentException("Invalid attempt to bind an instance of " + instance.getClass().getName() + " as a @JsonAdapter for " + type.toString()
